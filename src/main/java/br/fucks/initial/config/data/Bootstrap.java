...
public class Bootstrap implements InitializingBean {
    ...
    public void createProfiles() {
        ...
        for (GrupoPermissao grupo : this.permissoes) {
            admProfile.setPermissoes(grupo.getPermissoes());
        }
        ...
        userProfile.setPermissoes(new ArrayList<Permissao>());

        userProfile.getPermissoes().add(this.accountService.findPermissaoByName(SystemPermissions.USUARIOS_LIST));
    ...
    public void createUsers() {
        ...
        user.setProfile(this.accountService.findProfileByName("Administrador"));
